...
export default class AudioAbility extends UIAbility {
  ...
  onDestroy() {
    Logger.info(TAG, 'AudioAbility onDestroy')
  }

  onWindowStageCreate(windowStage: Window.WindowStage) {
    // Main window is created, set main page for this ability
    Logger.info(TAG, 'AudioAbility onWindowStageCreate')
  ...
  onWindowStageDestroy() {
    ...
    Logger.info(TAG, 'AudioAbility onWindowStageDestroy')
  }

  onForeground() {
    // Ability has brought to foreground
    Logger.info(TAG, 'AudioAbility onForeground')
  }

  onBackground() {
    // Ability has back to background
    Logger.info(TAG, 'AudioAbility onBackground')
  }
}
