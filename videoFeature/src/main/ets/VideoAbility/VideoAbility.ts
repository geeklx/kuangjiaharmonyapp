...
export default class VideoAbility extends UIAbility {
  ...
  onDestroy() {
    Logger.info(TAG, 'MyAbilityStage onDestroy')
  }

  onWindowStageCreate(windowStage: Window.WindowStage) {
    // Main window is created, set main page for this ability
    Logger.info(TAG, 'MyAbilityStage onWindowStageCreate')
  ...
  onWindowStageDestroy() {
    ...
    Logger.info(TAG, 'MyAbilityStage onWindowStageDestroy')
  }

  onForeground() {
    // Ability has brought to foreground
    Logger.info(TAG, 'MyAbilityStage onForeground')
  }

  onBackground() {
    // Ability has back to background
    Logger.info(TAG, 'MyAbilityStage onBackground')
  }
}
